...
# 現行ログindex【サーバパス】
$nowfile = './../../patio/data/index1.log';

# 過去ログindex【サーバパス】
$pastfile = './../../patio/data/index2.log';
...
# コピー商品系禁止ワード
# $no_wd = $no_wd.',スーパーコピー,S級品,A級品,送料無料,財布';

# 英語系禁止ワード ※簡単な英語でコメントする英語の迷惑投稿対策です。URLで引っかかる可能性もあります
# $no_wd = $no_wd.',good,best,guestbook,Interesting,Hammm';

# 英語コードの「'」対策 ※文字化けのせいで英語のみと認識されない引っかからない単語
# $no_wd = $no_wd.',’,that卒s';

# その他の言語系禁止ワード ※日本人が使わないと思われる単語
# $no_wd = $no_wd.',Сиськи';

# URL系禁止ワード ※宣伝系の迷惑書き込みの特徴的なURL部分を指定
# 　　　　　　　　ブロックログを注意して確認しないと、通常の書き込みをブロックしやすいです
# $no_wd = $no_wd.'282814,007ihost,100webspace,101freehost,115navi,117-ero,11-nioi,12gbfree,1g8sr4,1stbenefits,247ihost,2www,3ae6ucb,4infovision,59d,81f,87koala,abaoa,adsenseru,adult,adult-value,ai.aisite-hosii,aiai-honey,akiramenaidene,alive-iine,all-thetime-you,a-lot-of-deai,anahorisan,anal,angelfire,annkokunokizinn6487325,aportachannel,arc-jpn,av-lovemania,azcafe,best-7-couple,bigtits.1gb,bikerboyz,bikubikubikini,bitdom,bitxcl2.blog48,bitxcl2.blog48.fc2,blogspot,bocaroyale,born-again-christian,bravehost,bt.ktxp,buddyprofile,caremoon,casino,c-cock,cham-news,chocolateladytreats,christianskitscripts,churappa,chwweb,cialis,clayfis22fjs,clearmethods,cloud,cloud.prohosting,club4,cnn,copulation69,cossackbrothers,cute-lala,czykinax,dartmouth,dashinuke,deai,deai-megami,dekiru4,denise-milani,denvereruv,diazepam,diet,digmun,diorer,disabledsg,division7,donby,d-ota,dp-117,dragonball.z-mode,dtiblog,dtjapan,dvxvb,dzz2,eastpapuan.ling.su,ee-ro,ekanpo,ekanpou,ero2,eromeimei,erorin,eters,ettina-anoko,ewqe-r,excellent3,fansfc,fatfreehost,fd532,fe7a4,firelily,fm7,f-mama,forumforfree,freehyperspace,freephpwebhosting,freespirits,freeweb7,freewebs,freshgirls.1gb,friscomountainrentals,from-today-we,frskfrsk,fuyuiro,garl-navi,gatech,g-blend,georgiatemple,get-loud-da,giftsbygrove,gomang-usa,googleweb953,gregory.free-site-host,g-sf,guestbook,gyaku-h,hamburg,harborsupply,hevry,hips,h-no1,home.planet,home.wanadoo,homeequitylineofcredit,hostaim,hostpresso,hotelcorona,href,huizengahergt,hydrastore,iikamone,iikannkei,imasugu-aeru,insurance,ireteiiyo,irisembroidery,iwanttowheelie.co.,jackie-guerrido,jj-i,joolo,kane-kane-kudasai,kikennna-koi-koi,kiss-kiss-girls,kmcbaskets,koi-kami,koi-suppot,konnano-hazimete,kp-pro,krieh,ldskfhha,leslies,lifestyle-072,likecureslike,lingamesjp,loan,lolicolle,lord,lover-good,lppulu,lv-sale,lvyahoo,m_ona,madara28,map4,masserspuds,m-boo,mdern,mens-laugh-last,metacritic,minnieerecting,mistress2,mixy-7,mogura99,momiton,mona,morpca,mortgage,myfreewebhost,naked,narod,natu.ero-natu,navi-u,navi-y,ngkeun,nikoniko-club,nikoniko-club.comuntouchable-man,nonanona,norato,nrg-search,nude,nuki-navi,nurenure-okusan.nurenure-okusan,nwkaj.free-site-host,ocean-acros,oernyu,ometroro,ona.ona-m,onenight-in-paris,onny,onshaver,opiece,opiece.com,ora5ora,otonano,otona-spot,pacaeromodel,paimomi,paipai,pajdsk,pasxcl,peach-push,pemisi,petal-lip,pharmacy,pjcollectors,planetsti,pluto,poker,pokerprince,porn,poteto56,ppp-sereb,prnewsmedia,projector-beijing,puccol,puripuritan,quest,ranchocicadaretreat,rasiel,reachtranslation,republika,retgrs,ripway,robinsfcu,room-in-girl,saigomade,saikou.etti-saikou,s-auction,s-beauty,sblog,sefure-annai,sekkutyu,sex,sex.sex-maniax,sex.sex-o,sex-sexs,s-fr,sha-la-la-baby,sharonpaper,sheffield-mfg,shigajet,shop-pro,sinclair,singbarbershop,siski,sky-hart,slave-sm,sm-ero,smplay,snao.z-mode,sodenoshita,spa-guy,sukisuki-gal,sunxyivchai,swell.swell-up,syansyan-siyo,tatu-yo,tc,tchjs.,tokusenshop,tometomes,touchpoint,transaqtion,truly-it-coco,tulane,tyfo,u-98,ublib.buffalo,uiowa,ullohn,untouchable-man,usdil,value=,viagra,vicodin.envy,wananchi,warp-station,welcome,wellbrandshop,westerbraehighlandlodges,white,white.prohosting,wiiwi,woman-line,wwwa,wydi,x07,xn--cck0cya3lp32zbqo,xn--ick7bf6125cybm,xn--n8j890gcxag5af4d,xn--vus757,xyevdrom,yattane-sex,ynglingsailing,youmenipip,z-night,zz84,6v-aa,jpsogreat';
...
# → 例 : 102400 = 100KB
$maxdata = 8388608; # 8 * 1024 * 1024 (8MB)

# GIF画像1枚あたりの最大投稿サイズ (bytes)
$maxdata_gif = 1048576; # 1 * 1024 * 1024 (1MB)
...
# → 順に、サーバパス、URLパス
$thumbdir = './../../patio/thumb';
$thumburl = './../../patio/thumb';
...
EOM
    ...
    if((caller 1)[3] =~ /^.*::view$/) {
		...
		# スレッドNoを自動書き込み禁止機能のレス部分相当で動作する機能
		# スレッドタイトルを自動書き込み禁止機能のレス部分相当で動作する機能
		print "<script type=\"text/javascript\" src=\"js/_original/read_prohibit.js\"></script>\n";
	}
